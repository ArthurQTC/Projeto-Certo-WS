...
import { Mail, Phone, MapPin, ChevronDown, Menu, X, Instagram, Facebook, Linkedin, ArrowUp, Database } from 'lucide-react';
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-brand-gold selection:text-white">
          ...
          <div className="max-w-7xl mx-auto px-6 w-full flex justify-between items-center text-[10px] uppercase tracking-widest font-medium">
            ...
            <div className="flex items-center space-x-6">
              ...
              <button 
                ...
                className="flex items-center text-brand-gold hover:text-white transition-colors cursor-pointer font-bold tracking-widest uppercase border-l border-white/10 pl-6 h-4"
              >
        ...
        <nav className={`h-20 transition-all duration-500 border-b ${scrolled ? 'bg-white/95 backdrop-blur-md border-gray-100 shadow-sm' : 'bg-transparent border-white/10'}`}>
          <div className="max-w-7xl mx-auto px-6 h-full flex justify-between items-center">
            ...
            <div className="hidden lg:flex items-center space-x-10">
              ...
              <button className="bg-brand-gold text-white px-8 py-3 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-brand-gold-dark transition-all">
                Orçamento
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-500 text-sm font-light leading-relaxed max-w-md mb-10">
              Soluções arquitetônicas inteligentes. Distribuidor autorizado Hunter Douglas no Distrito Federal, Goiás e Tocantins. Excelência técnica e compromisso com o design.
            </p>
      ...
      <SupabaseManager isOpen={isDbOpen} onClose={() => setIsDbOpen(false)} />
    </div>
  );
}
